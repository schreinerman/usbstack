...
/** \file usbhosthw.h
 **
 ** USB host hardware settings for fssdc-9b506-evb evaluation board
 **
 ** History:
...
#define HOST0VBUS_INIT FM3_GPIO->DDR6 |= (1 << 7)
#define HOST0VBUS_SET FM3_GPIO->PDOR6 &= ~(1 << 7)
#define HOST0VBUS_CLEAR FM3_GPIO->PDOR6 |= (1 << 7)
...
#define HOST0OVERCURRENT_DISABLEISR bFM3_EXTI_ENIR_EN11 = 0
#define HOST0OVERCURRENT_ENABLEISR bFM3_EXTI_ENIR_EN11 = 1
#define HOST0OVERCURRENT_CLEARISRFLAG bFM3_EXTI_EICL_ECL11 = 0
#define HOST0OVERCURRENT_ISRISSET bFM3_EXTI_EIRR_ER11 == 1
#define HOST0OVERCURRENT_SETLOWDETECT bFM3_EXTI_ELVR_LA11 = 0
#define HOST0OVERCURRENT_SETHIGHDETECT bFM3_EXTI_ELVR_LA11 = 1
#define HOST0OVERCURRENT_HIGHDETECT (FM3_GPIO->PDIR6 & (1 << 6)) > 0
#define HOST0OVERCURRENT_INIT FM3_GPIO->DDR6 &= ~(1 << 6)
