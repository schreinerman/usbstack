...
/** \file usbhosthw.h
 **
 ** USB host hardware settings for fssdc-9a314-evb evaluation board
 **
 ** History:
...
#define HOST0OTGPULLDOWN_INIT FM3_GPIO->DDR0 |= (1 << 0x0C)
#define HOST0OTGPULLDOWN_SET FM3_GPIO->PDOR0 |= (1 << 0x0C)
#define HOST0OTGPULLDOWN_CLEAR FM3_GPIO->PDOR0 &= ~(1 << 0x0C)
