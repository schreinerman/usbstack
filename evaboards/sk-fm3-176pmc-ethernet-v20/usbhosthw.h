...
/** \file usbhosthw.h
 **
 ** USB host hardware settings for sk-fm3-176pmc-ethernet evaluation board
 **
 ** History:
...
#define HOST0VBUS_INIT FM3_GPIO->DDRC |= 0x0400
#define HOST0VBUS_SET FM3_GPIO->PDORC &= ~0x0400
#define HOST0VBUS_CLEAR FM3_GPIO->PDORC |= 0x0400
#define HOST0VBUS_GET ((FM3_GPIO->PDORC & 0x0400) > 0)
#define HOST0VBUS_ENABLED 1

#define HOST0OTGPULLDOWN_DEINIT 
#define HOST0OTGPULLDOWN_INIT FM3_GPIO->DDRC |= 0x0200
#define HOST0OTGPULLDOWN_SET FM3_GPIO->PDORC |= 0x0200
#define HOST0OTGPULLDOWN_CLEAR FM3_GPIO->PDORC &= ~0x0200
