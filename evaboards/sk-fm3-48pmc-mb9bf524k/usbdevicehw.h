...
/** \file usbdevicehw.h
 **
 ** USB device hardware settings for sk-fm3-48pmc-mb9bf524k evaluation board
 **
 ** History:
...
#define DEVICE0VBUS_INIT bFM3_GPIO_ADE_AN20 = 0; bFM3_GPIO_ADE_AN21 = 0; bFM3_GPIO_PFR6_P0  = 1; bFM3_GPIO_DDR6_P0 = 0; bFM3_GPIO_EPFR06_EINT15S1 = 1; if ((USB_USE_L3 == 0) && (USB_USE_EXT_INT == 1)) { NVIC_ClearPendingIRQ(EXINT8_23_IRQn); NVIC_EnableIRQ(EXINT8_23_IRQn); NVIC_SetPriority(EXINT8_23_IRQn,1); }
