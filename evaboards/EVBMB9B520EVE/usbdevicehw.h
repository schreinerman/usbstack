...
#define DEVICE0VBUS_INIT                                  bFM3_GPIO_PFR6_P0  = 1; bFM3_GPIO_DDR6_P0 = 0; bFM3_GPIO_EPFR06_EINT15S1 = 1; if ((USB_USE_L3 == 0) && (USB_USE_EXT_INT == 1)) { NVIC_ClearPendingIRQ(EXINT8_23_IRQn); NVIC_EnableIRQ(EXINT8_23_IRQn); NVIC_SetPriority(EXINT8_23_IRQn,1); }
