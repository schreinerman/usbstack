...
/** \file usbhosthw.h
 **
 ** USB host hardware settings for SK-FM3-100PMC-MB9AFB44N evaluation board
 **
 ** History:
...
#define HOST0VBUS_INIT FM3_GPIO->DDR4 |= (1 << 2)
#define HOST0VBUS_SET FM3_GPIO->PDOR4 &= ~(1 << 2)
#define HOST0VBUS_CLEAR FM3_GPIO->PDOR4 |= (1 << 2)
#define HOST0VBUS_GET ((FM3_GPIO->PDORC & 0x0400) > 0)
#define HOST0VBUS_ENABLED 1

#define HOST0OTGPULLDOWN_DEINIT 
#define HOST0OTGPULLDOWN_INIT FM3_GPIO->DDR4 |= (1 << 3)
#define HOST0OTGPULLDOWN_SET FM3_GPIO->PDOR4 |= (1 << 3)
#define HOST0OTGPULLDOWN_CLEAR FM3_GPIO->PDOR4 &= ~(1 << 3)
